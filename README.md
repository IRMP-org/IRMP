...
- NEC, Kaseiko, Denon, RC6 were sucessfully tested in interrupt mode.
...
- For AVR timer 2 (Tone timer) is used, for variants, which have no timer 2 like ATtiny85, timer 1 is used.
...
It is dated from **2.4.2019**. If you have complains about the data or request for extensions, please send a PM or open an issue.
...
| Supported platforms | **avr, esp8266, ESP32, STM32<br/>(plus arm and pic for non Arduino IDE)** | avr, esp8266 | avr, arm(samd) | avr, attiny, esp8266, esp32, arm |
