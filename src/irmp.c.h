 ...
 */
const uint8_t
irmp_used_protocol_index[] PROGMEM =
{
...
const char * const
irmp_used_protocol_names[] PROGMEM =
{
    proto_unknown,
#if IRMP_SUPPORT_SIRCS_PROTOCOL == 1
    proto_sircs,
...
#if IRMP_SUPPORT_MATSUSHITA_PROTOCOL == 1
                    if (irmp_pulse_time >= MATSUSHITA_START_BIT_PULSE_LEN_MIN
                            && irmp_pulse_time <= MATSUSHITA_START_BIT_PULSE_LEN_MAX
                            && irmp_pause_time >= MATSUSHITA_START_BIT_PAUSE_LEN_MIN
                            && irmp_pause_time <= MATSUSHITA_START_BIT_PAUSE_LEN_MAX)
                    {                                                           // it's MATSUSHITA
#ifdef ANALYZE
