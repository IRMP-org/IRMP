...
#define IRSND_IR_FREQ_38_KHZ                    38000
#define IRSND_INTERRUPT_FREQ_FOR_38_KHZ         (IRSND_IR_FREQ_38_KHZ * 2)  // *2 to toggle output pin at each interrupt
/*
 ...
 */
#  undef  F_INTERRUPTS
#  define F_INTERRUPTS                          (IRSND_IR_FREQ_38_KHZ / 2)   // 19000 interrupts per second
