...
static volatile uint8_t irsnd_buffer[11] =
{ 0 };
...
#    if F_CPU >= 16000000L
    OCR1B = OCR1C = (F_CPU / IRSND_INTERRUPT_FREQ_FOR_38_KHZ / 8) - 1;  // compare value: 1/72000 of CPU frequency, presc = 8
    TCCR1 = (1 << CTC1) | (1 << CS12);                                  // switch CTC Mode on, set prescaler to 8
#    else
    OCR1B = OCR1C = (F_CPU / IRSND_INTERRUPT_FREQ_FOR_38_KHZ / 4) - 1;  // compare value: 1/72000 of CPU frequency, presc = 4
    TCCR1 = (1 << CTC1) | (1 << CS11) | (1 << CS10);                    // switch CTC Mode on, set prescaler to 4
#    endif
    TIMSK = (1 << OCIE1B);                                              // enable compare match interrupt

#  elif defined(__AVR_ATtiny87__) || defined(__AVR_ATtiny167__)
    OCR1B = ICR1 = (F_CPU / IRSND_INTERRUPT_FREQ_FOR_38_KHZ ) - 1;              // compare value: 1/72000 of CPU frequency, presc = 8
 ...
 * Called every 13.5us
 * Bit bang requires 2 us, with call of irsnd_ISR() from 4.4 us to 13.0 - measured by scope
...
//    digitalWriteFast(IRMP_TIMING_TEST_PIN, HIGH); // 0.7 to 1.3us
...
#  endif
//digitalWriteFast(IRMP_TIMING_TEST_PIN, LOW);
}
